...
4. [Network Design and Implementation](#Network-Design-and-Implementation)
...
### Architecture
![Architecture image text](https://github.com/cepdnaclk/e16-4yp-Enhancement-of-Efficiency-of-Vehicular-Communication-using-SDN/blob/main/docs/images/arch.png)
